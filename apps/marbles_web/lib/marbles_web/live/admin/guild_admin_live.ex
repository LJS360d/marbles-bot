  ...
  def render(assigns) do
    ...
    <Layouts.app flash={@flash} current_user={@current_user} current_scope={@current_scope}>
      <div class="rounded-2xl border border-base-300 bg-base-200 p-6">
        ...
        <p class="mt-2 text-base-content/80">Manage settings for servers where you are an administrator.</p>
        <p class="mt-4 text-sm text-base-content/60">Placeholder — server list and per-guild settings coming soon.</p>
      </div>
    </Layouts.app>
    """
  end
